...
void							all_not_dijkstra_fill(t_avl_str *room, \
										t_avl_str *edge_in, \
										t_my_queue *queue, t_avl_str *start);
void							all_not_dijkstra_suffix(t_avl_str *root, \
										t_my_queue *queue, \
										t_avl_str *start);
void							all_abcdefghijk(t_avl_str *edge_out, \
										t_my_queue *queue, \
										t_avl_str *start);
void							reset(t_avl_str *start);
void							reset_suffix(t_avl_str *root, \
										t_my_queue *queue);
void							not_dijkstra(t_avl_str *start);
void							not_dijkstra_fill(t_avl_str *room, \
										t_avl_str *edge_in, \
										t_my_queue *queue);
void							not_dijkstra_suffix(t_avl_str *root, \
										t_my_queue *queue, char flag);
void							abcdefghijk(t_avl_str *edge_out, \
										t_my_queue *queue);
void							all_not_dijkstra(t_avl_str *start, \
										t_avl_str *end);
...
void							move_ants_if(t_ant **tmp, t_ant **prev, \
										t_ants *ingame);
...
t_str_list						*is_valid_map(t_read *term);
void							is_valid(t_read *term, t_str_list \
										*str_list, int is_start);
t_avl_str						*init_node(t_read *term, char *str, \
										int *is_start);
int								push_edges(t_read *term, char *str, \
										t_str_list *str_list);
